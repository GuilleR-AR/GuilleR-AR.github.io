...
For provisioning I use templates, Ansible scripts and Terraform; see my Talos Terraform module for Kubernetes deployment: [2025-10-21-created-my-own-tf-module-for-k8s-deployment.md](../_posts/2025-10-21-created-my-own-tf-module-for-k8s-deployment.md).
